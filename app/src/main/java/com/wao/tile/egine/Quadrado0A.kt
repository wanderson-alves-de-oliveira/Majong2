        ...
        for (i in 0 until 27) {
            ...
            when (disponiveis[index]) {
                in 0..15 -> {
                    ...
                    when (disponiveis[index]) {
                        in 0..3 -> {
                            y = tamNovo.toFloat()+(tamm*tamNovo.toFloat())
                        }

                        in 4..7 -> {
                            y = (tamNovo.toFloat() * 2)+(tamm*tamNovo.toFloat())
                        }
                ...
                in 16..26 -> {
                    ...
                    when (disponiveis[index]) {
                        in 16..18 -> {
                            y =( (tamNovo.toFloat() * 1)+ (tamNovo.toFloat() / 2))+(tamm*tamNovo.toFloat())
                        }
                        ...
                        in 25..27 -> {
                            y = ((tamNovo.toFloat() * 4) + (tamNovo.toFloat() / 2))+(tamm*tamNovo.toFloat())
                        }
